...
function transitionToGame(e) {
    ...
    // Buka halaman prep-quest.html di tab baru
    // File ini berisi Persiapan Bermain + Loading Screen + navigasi ke games.html
    const newWin = window.open('prep-quest.html', '_blank');
    if (!newWin) {
